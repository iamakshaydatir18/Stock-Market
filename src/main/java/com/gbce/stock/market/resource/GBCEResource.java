package com.gbce.stock.market.resource;
...
import com.gbce.stock.market.service.StockService;
import com.gbce.stock.market.service.TradeService;
...
public class GBCEResource {
     ...
     */
    @Autowired
    public GBCEResource(final StockService stockService,
